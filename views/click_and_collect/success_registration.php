        ...
        <div class="container pt-5 mt-4">
            ...
            <div class="form_shadow card col-md-3 p-4 mx-auto mt-3 rounded-1 border-0">
                <form action="" class="py-2">
                    <div class="bg_white">
                        <h4 class="text_header_3 m-0 p-0 text-center">Account Registered!</h4>
                    </div>
                    <div class="text_input">
                        <div class="success_icon text-center p-0">
                            <i class="bi bi-check-circle"></i>
                            <p class="text_requirements">Congratulations, your account has been successfully created.</p>
                        </div>
                        <div class="mb-3">
