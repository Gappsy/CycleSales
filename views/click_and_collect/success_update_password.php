        ...
        <div class="container pt-5 mt-4">
            ...
            <div class="form_shadow card col-md-3 p-4 mx-auto mt-3 rounded-1 border-0">
                <form action="" class="py-2">
                    <div class="bg_white">
                        <h4 class="text_header_3 m-0 p-0 text-center">Update Successful!</h4>
                    </div>
                    <div class="text_input">
                        <div class="success_icon text-center p-0">
                            <i class="bi bi-check-circle"></i>
                            <p class="text_requirements">Your password has been updated. Click the button below to continue.</p>
                        </div>
                        <div class="mb-3">
                            <a href="../../public/shop_login.php" class="btn btn-primary w-100 rounded-1 p-2">Back to Login</a>
                        </div>
                    </div>
                </form>
            </div>
