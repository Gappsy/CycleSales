                    ...
                    <div class="text_input">
                        <div class="mb-3">
                            <div class="mt-3 text-center">
                                <p class="text_header_2 mb-2">Enter Verification Code</p>
                                <p class="text_requirements">A verification code has been sent to +09******123</p>
                            </div>
                            <input type="contact_num" class="form-control rounded-1 focus-ring" id="contact_num" name="contact_num" required>
                        </div>
                        <div class="mb-3">
                            <button type="submit" class="btn btn-primary w-100 rounded-1 p-2">Verify</button>
                        </div>
